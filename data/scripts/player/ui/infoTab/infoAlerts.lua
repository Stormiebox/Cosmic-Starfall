...
function infoAlerts.DebugMsg(_text)
	if _debug then
		include("cosmicvaultdebug").info("Cosmic Starfall", 'infoAlerts|',_text)
	end
end
...
entities['weapons'] = {
	...
	--Content
	{
		...
		},
		{
			...
			'Non-interactive - triggered when the enemy destroys one of your turrets'%_t, -- Content. Text or path to picture.
		},
	},
}