...
--Creates a labelBox for the weapon list
...
entities['laser'] = {
	...
	--Changes
	{
		descDetails['bonusdamageincrease']..'110%',
...
entities['bolter'] = {
	...
	--Changes
	{
		descDetails['bonusdamageincrease']..'5%',
		descDetails['techleveltoprojspeed'],
...
entities['lightinggun'] = {
	...
	--Changes
	{
		descDetails['classToHeavy'],
		descDetails['bonusdamageincrease']..'10%',
		'Rate of fire significantly reduced (damage remains the same)'%_t,
		descDetails['accemblyDamageByParts']..descDetails['inc'],
		descDetails['morepartsDamage'],
...
entities['tesla'] = {
	...
	--Changes
	{
		descDetails['bonusdamageincrease']..'150%',
		descDetails['bonusToShields']..'30%',
		descDetails['morepartsDamage'],
		descDetails['lesspartsRange'],
		'During assembly: one of the parts now gives additional damage to shields'%_t,
