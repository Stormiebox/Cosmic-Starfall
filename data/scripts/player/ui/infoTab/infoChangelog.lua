...
local listboxLabelSizeK = 0.7 -- Size coefficient of rUnit for listbox labels
local listboxLabelFontSizeK = 0.32 -- Font size coefficient of rUnit for listbox labels
...
function infoChangelog.SetEntitiesV2(container,rUnit,gUK)
	...
	--Generate lines in listBox according to segments
	for i=1,#segments do
...
--Creates label for list in LEFT
...
--Creates labelBox for list in LEFT
...
--Creates infobox list for RIGHT
...
function infoChangelog.SetMain(stType,baseContainer,rUnit)
	...
	for _index,_rows in pairs(data) do
		...
		local dataInfo = _rows[3] --Description or icon path
...
--Creates text field in RIGHT tab
...
--Creates picture + sub-element name in RIGHT tab
...
local updateLines = {}
	updateLines['2.0.0'] = {
		"Massive codebase refactor and modernization for Avorion 2.5+ compatibility.",
		"Fixed silent crashes in UI UIVerticalSplitter and UIHorizontalSplitter components.",
		"Refactored repair drones to natively display fractional percentages.",
		"Safely hooked into AI weapon generation to prevent overwriting vanilla arrays.",
		"Fixed a severe exploit where clients could transfer cargo from any entity regardless of ownership.",
	}
	updateLines['0.2'] = {
...
entities['2.0.0'] = {
	...
	--Content
	{
		...
		},
		{
			'desc', -- Element type
			14, -- Height
			self.transformToSingleLine(updateLines['2.0.0']), -- Content.
		},
	},
}
entities['0.2'] = {
	...
	--Content
	{
		...
		},
		{
			'desc', -- Element type
			8, -- Height
			self.transformToSingleLine(updateLines['0.2']), -- Content.
		},
	},
}
entities['0.3'] = {
	...
	--Content
	{
		...
		},
		{
			'desc', -- Element type
			8, -- Height
			self.transformToSingleLine(updateLines['0.3']), -- Content.
		},
	},
}
