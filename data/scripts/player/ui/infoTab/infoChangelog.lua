	...
	{
		{
			...
			'data/textures/icons/clipboard-arrow-down.png', -- Содержимое. Текст или путь к картинке.
		},
		{
			'desc', -- Тип элемента
			8, -- Высота (nil для iconname/mainlabel)
			self.transformToSingleLine(updateLines['0.2']), -- Содержимое. Текст или путь к картинке.
		},
	},
}
entities['0.3'] = {
	...
	--Содержимое
	{
		...
		},
		{
			'desc', -- Тип элемента
			8, -- Высота (nil для iconname/mainlabel)
			self.transformToSingleLine(updateLines['0.3']), -- Содержимое. Текст или путь к картинке.
		},
	},
}
