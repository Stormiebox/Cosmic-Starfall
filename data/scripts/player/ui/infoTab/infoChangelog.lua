	...
	{
		{
			...
			'data/textures/icons/clipboard-arrow-down.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			8, -- Height (nil for iconname/mainlabel)
			self.transformToSingleLine(updateLines['2.0.0']), -- Content. Text or path to picture.
		},
	},
}
entities['0.2'] = {
	...
	--Content
	{
		...
		},
		{
			'desc', -- Element type
			8, -- Height (nil for iconname/mainlabel)
			self.transformToSingleLine(updateLines['0.2']), -- Content. Text or path to picture.
		},
	},
}
entities['0.3'] = {
	...
	--Content
	{
		...
		},
		{
			'desc', -- Element type
			8, -- Height (nil for iconname/mainlabel)
			self.transformToSingleLine(updateLines['0.3']), -- Content. Text or path to picture.
		},
	},
}
