...
function iT.initialize()
	...
	--Если запустить через проход таблицы, табы будут каждый раз рандомно смешаны :)
...
--Создает вкладку, служебная для initialize
...
--Создает базовое содержимое вкладок
...
--Инициализирует сегмент сущностей
...
--Инициализирует информационный сегмент
...
--Отображает сгенерированную информацию при нажатии на сущность (общее)
function iT.onClickGeneral(index)
	...
	for _name,_rows in pairs(labelBoxTable['general']) do
		if _rows.selectedValue then
			...
			--Проверка табов на совпадение по названию
...
--Отображает сгенерированную информацию при нажатии на сущность (оружие)
...
--Отображает сгенерированную информацию при нажатии на сущность (системы)
...
--Отображает сгенерированную информацию при нажатии на сущность (станции)
...
--Отображает сгенерированную информацию при нажатии на сущность (интерфейсы)
...
--Отображает сгенерированную информацию при нажатии на сущность (алерты)
...
--Отображает сгенерированную информацию при нажатии на сущность (чейнджлог)
