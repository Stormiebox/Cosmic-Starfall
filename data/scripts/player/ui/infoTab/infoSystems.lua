...
--Создает и заполняет листбоксы для LEFT
...
function infoSystems.SetMain(sysType,baseContainer,rUnit)
	...
	if sysSpellsTable then
		...
		for _,_rows in pairs(sysSpellsTable) do
			...
			local hModifier = 1 --для иконки и названия
...
--Создает линию текста для инфотаба
...
entities['bastionSystem'] = {
	...
	1, -- модификатор высоты окна описания от стандартного
	},
	--Пассивные бонусы / штрафы
	{
...
entities['macrofieldProjector'] = {
	...
	1.4, -- модификатор высоты окна описания от стандартного
	},
	--Пассивные бонусы / штрафы
	{
	...
	--Активные эффекты
	{
		...
		
		{
			...
			1.1 -- модификатор высоты окна описания от стандартного
		},
		
		{
			...
			1.2 -- модификатор высоты окна описания от стандартного
		},
