...
local order = {
	...
	{locNames['systemsnew'],'setbonuses',0.1},
...
local listboxLabelSizeK = 0.7 -- rUnit size coefficient for listbox labels
local listboxLabelFontSizeK = 0.32 -- rUnit text size coefficient for listbox labels
...
--Creates a labelBox for the list in LEFT
...
--Creates a picture in the RIGHT tab
...
--Creates a picture + sub-element name in the RIGHT tab
	...
	{
		{
			...
			'data/textures/icons/ASSAULTBLASTER.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			1.3, -- Height (nil for iconname/mainlabel)
			"A new characteristic of weapon: 'class' determines the behavior of various types of weapons in some situations. You can see the class of the gun in the information panel of the turret, the corresponding line will be located at the very top"%_t, -- Content. Text or path to picture.
		},
		{
		...
		},
		{
			...
			'Weapons of this class cannot be used in the production of fighters'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
	...
	{
		{
			'mainlabel', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
			'data/textures/icons/HYPERKINETIC.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			1.1, -- Height (nil for iconname/mainlabel)
			"17 new weapons have been added to the game. You can find out more about each one in the tab 'Weapons'"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			...
			'Class: Standard. Rapid-fire low- and medium range weapon. does not overheat'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1, -- Height (nil for iconname/mainlabel)
			'Class: Standard. Light accurate medium-range weapon'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			...
			'Class: Standard. Medium-range rapid-fire weapon that deals increased damage to shields'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: Standard. Universal medium-range plasma cannon'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: Standard. Long-range homing weapon designed to deal against mobile targets'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: Standard. Powerful, but not very accurate rail-type plasma weapon'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: Defensive. Rapid-fire weapon against fighters'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: light. A rapid-firing light low-range weapon designed for fighters'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: light. A versatile powerful, but not very accurate medium-range weapon designed for fighters'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: light. A long-range siege weapon designed for fighters'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: light. Beam weapon for hull repair, designed for fighters'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: light. A beam gun for repairing shields, designed for fighters'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: heavy. A powerful siege weapon designed for heavy ships'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: heavy. A powerful siege weapon designed for heavy ships. Deals serious damage to enemy shields'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: Main caliber. High-powered sniper weapon capable of destroying vulnerable targets with a single shot'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: Main caliber. A siege weapon capable of inflicting massive damage to slow and stationary targets'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: Main caliber. A weapon capable of inflicting great damage to any targets at a long distance, but in need of a long recharge'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.4, -- Height (nil for iconname/mainlabel)
			'Class: Main caliber. A universal laser heavy weapon that deals good damage at medium range'%_t, -- Content. Text or path to picture.
		},
	},
}
...
entities['weaponrebalance'] = {
	...
	--Content
	{
		...
		},
		{
			'desc', -- Element type
			1.3, -- Height (nil for iconname/mainlabel)
			"Almost all vanilla weapons have changes that somehow increase their combat potential. This also affects opponents, making them more dangerous. The full list of changes is available in the 'Weapons' tab"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1, -- Height (nil for iconname/mainlabel)
			'Class: Standard. Base damage increased. The damage, range and speed of the projectile will increase further with the technical level'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1, -- Height (nil for iconname/mainlabel)
			'Class: Standard. The base damage is increased and range is slightly reduced. Now it pierces up to two blocks. During assembly, it receives bonus damage on shields'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1, -- Height (nil for iconname/mainlabel)
			"Class: Standard. The base damage is increased and additionally increases with the tech level. The base range also increases slightly with the tech level. Bonus damage to shields increases during assembly"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1, -- Height (nil for iconname/mainlabel)
			'Class: heavy. The class has been changed, the damage has been increased, the assembly bonuses have been redesigned. During production, it is possible to increase the flight speed of missiles, but the range has become lower'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			...
			"Class: heavy. The class has been changed. The base damage has been increased, and the weapon now receives a base bonus to damage on shields and hull. Can no longer receive the Antimatter damage type. Gets big bonuses during assembly"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.2, -- Height (nil for iconname/mainlabel)
			'Class: heavy. The class has been changed. The logic of use has been redesigned - now it is a low- and medium-range weapon operating like a slug gun'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.2, -- Height (nil for iconname/mainlabel)
			'Class: Standard. The basic repair has been greatly increased and will be further increased with tech level. During assembly, the range is greatly increased'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.2, -- Height (nil for iconname/mainlabel)
			'Class: Standard. The base damage is increased, the threshold of the minimum rate of fire is increased, and the base speed of the projectile will increase with the tech level. Gets more bonuses during assembly'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.2, -- Height (nil for iconname/mainlabel)
			'Class: heavy. The class has been changed. The base damage is increased, the rate of fire is significantly reduced (does not affect damage). Receives strong bonuses during assembly'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.2, -- Height (nil for iconname/mainlabel)
			"Class: Standard. Shield damage increased. Can no longer receive the type of damage 'plasma', however, during assembly, the damage to shields increases significantly, as well as normal damage"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.2, -- Height (nil for iconname/mainlabel)
			'Class: Standard. Base damage is noticeably increased. The range of fire and the speed of the projectile will increase with tech level. Assembly bonuses are increased'%_t, -- Content. Text or path to picture.
		},
	},
}
...
entities['systemnew'] = {
	...
	--Content
	{
		...
		},
		{
			'desc', -- Element type
			2, -- Height (nil for iconname/mainlabel)
			"Designed to improve the survival ability of hull-based ships.\nIncreases  durability, applies additional passive repair in case of serious damage. Active abilities are aimed at repairing hull"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			2, -- Height (nil for iconname/mainlabel)
			'Designed for heavy shield-based ships.\nReduces the volume of the shield, but increases its regeneration and reduces the time before charging.\nActive abilities allow you to strengthen the shield, restore it, make it impenetrable and completely protect yourself from any torpedoes for a while'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			2, -- Height (nil for iconname/mainlabel)
			"Designed to specialize ship into repair class. Uses the ship's battery to generate repair beams or a powerful repair field"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			2, -- Height (nil for iconname/mainlabel)
			'Allows you to temporarily accelerate the radius of the tractor beam to large values'%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
	...
	{
		{
			'mainlabel', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
			'data/textures/icons/station.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			1.3, -- Height (nil for iconname/mainlabel)
			"New stations added by modification. For more information, see the 'stations' tab"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
	...
	{
		{
			'mainlabel', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
			'data/textures/icons/alert/AlertDeadTurret.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			1.3, -- Height (nil for iconname/mainlabel)
	...
	{
		{
			'mainlabel', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
			'data/textures/icons/FederationSC.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			1.3, -- Height (nil for iconname/mainlabel)
	...
	{
		{
			'mainlabel', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
			'data/textures/icons/ui/ui_circutry.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			1.3, -- Height (nil for iconname/mainlabel)
	...
	{
		{
			'mainlabel', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
			'data/textures/icons/ui/ui_invitePending.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			1.3, -- Height (nil for iconname/mainlabel)
	...
	{
		{
			'mainlabel', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
			'data/textures/icons/vortex.png', -- Content. Text or path to picture.
		},
		{
			'desc', -- Element type
			2, -- Height (nil for iconname/mainlabel)
			"Installing specific combinations of subsystems or accumulating enough turrets of the same type grants powerful passive Set Bonuses to your ship. Active Set Bonuses will be displayed dynamically on your HUD!"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			...
			"Requires: Bastion + Overpowered Core\nGrants: +20% Shield Recharge, +10% Shield Capacity"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.5, -- Height (nil for iconname/mainlabel)
			"Requires: Repair Drones + Tractor Beam Generator\nGrants: +2 Maximum Fighters"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
		...
		},
		{
			'desc', -- Element type
			1.5, -- Height (nil for iconname/mainlabel)
			"Requires: Xperimental Hyperdrive + Subspace Cargo\nGrants: +20% Jump Range, +15% Velocity"%_t, -- Content. Text or path to picture.
		},
		{
			'iconinfo', -- Element type
			nil, -- Height (nil for iconname/mainlabel)
