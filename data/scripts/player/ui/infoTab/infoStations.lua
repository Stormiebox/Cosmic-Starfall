	...
	{
		{
			...
			getStationIcon('mx'), -- Содержимое. Текст или путь к картинке.
		},
		{
			'desc', -- Тип элемента
			1.8, -- Высота (nil для iconname/mainlabel)
			getStationDesc('mx'), -- Содержимое. Текст или путь к картинке.
		},
		{
			'iconinfo', -- Тип элемента
			nil, -- Высота (nil для iconname/mainlabel)
			getInnerStationIcon('mxoutput'), -- Содержимое. Текст или путь к картинке.
			"'Production' tab"%_t -- Содержимое для icon info 
		},
		{
			'desc', -- Тип элемента
			1.8, -- Высота (nil для iconname/mainlabel)
			"The first tab (production) displays all stations that produce resources and transfer them to the complex. Each line represents a station and all its production streams (including the ratio of active production to off)"%_t, -- Содержимое. Текст или путь к картинке.
		},
		{
			'iconinfo', -- Тип элемента
			nil, -- Высота (nil для iconname/mainlabel)
			getInnerStationIcon('mxexpand'), -- Содержимое. Текст или путь к картинке.
			'Detailed Information button'%_t -- Содержимое для icon info 
		},
		{
			'desc', -- Тип элемента
			1.8, -- Высота (nil для iconname/mainlabel)
			"Expands an additional window in which all the production streams of the station are listed in detail. They can be turned on and off at your discretion. By disabling the stream, you will prohibit the megacomplex from taking a specific resource from a specific station"%_t, -- Содержимое. Текст или путь к картинке.
		},
		{
			'iconinfo', -- Тип элемента
			nil, -- Высота (nil для iconname/mainlabel)
			getInnerStationIcon('mxinput'), -- Содержимое. Текст или путь к картинке.
			"'Consumption' tab"%_t -- Содержимое для icon info 
		},
		{
			'desc', -- Тип элемента
			1.8, -- Высота (nil для iconname/mainlabel)
			"Displays all stations that need resources to work. Additionally displays the capabilities of the megacomplex to supply the station with resources produced by other docked stations. Here you can completely disable the supply of resources to the station by using the shutdown button to the right border of line"%_t, -- Содержимое. Текст или путь к картинке.
		},
		{
			'iconinfo', -- Тип элемента
			nil, -- Высота (nil для iconname/mainlabel)
			getInnerStationIcon('mxexpand'), -- Содержимое. Текст или путь к картинке.
			'Consumption Details button'%_t -- Содержимое для icon info 
		},
		{
			'desc', -- Тип элемента
			1.8, -- Высота (nil для iconname/mainlabel)
			"Expands an additional window in which all the consumption streams of the station are listed in detail. They can be turned on and off at your discretion. By disabling the stream, you will prohibit the megacomplex from transferring a specific resource to a specific station"%_t, -- Содержимое. Текст или путь к картинке.
		},
		{
			'iconinfo', -- Тип элемента
			nil, -- Высота (nil для iconname/mainlabel)
			getInnerStationIcon('mxstorage'), -- Содержимое. Текст или путь к картинке.
			"'Storage and utilization' tab"%_t -- Содержимое для icon info 
		},
		{
			'desc', -- Тип элемента
			1.8, -- Высота (nil для iconname/mainlabel)
			"This tab lists all the resources produced/consumed by the stations in one way or another. Here you can set a limit for a specific resource, check the consumption/production streams associated with the resource, and activate a special 'utilization' mode"%_t, -- Содержимое. Текст или путь к картинке.
		},
		{
			'iconinfo', -- Тип элемента
			nil, -- Высота (nil для iconname/mainlabel)
			getInnerStationIcon('mxtodelete'), -- Содержимое. Текст или путь к картинке.
			"'Utilization' Mode"%_t -- Содержимое для icon info 
		},
		{
			'desc', -- Тип элемента
			1.8, -- Высота (nil для iconname/mainlabel)
			"Experimental modification of the request from the stations: the complex will take this resource from them in the usual manner, but as soon as the stock on the complex reaches the limit, it will begin to completely remove this product from the warehouse of the manufacturing stations, thereby not allowing it to accumulate and stop the production process"%_t, -- Содержимое. Текст или путь к картинке.
		},
		{
			'iconinfo', -- Тип элемента
			nil, -- Высота (nil для iconname/mainlabel)
			getInnerStationIcon('mxexport'), -- Содержимое. Текст или путь к картинке.
			"'Export' tab"%_t -- Содержимое для icon info 
		},
		{
			'desc', -- Тип элемента
			1, -- Высота (nil для iconname/mainlabel)
			"The functionality of this tab is under development"%_t, -- Содержимое. Текст или путь к картинке.
		},
		{
			'iconinfo', -- Тип элемента
			nil, -- Высота (nil для iconname/mainlabel)
			getInnerStationIcon('mxsettings'), -- Содержимое. Текст или путь к картинке.
			"'Settings' tab"%_t -- Содержимое для icon info 
		},
		{
			'desc', -- Тип элемента
			1, -- Высота (nil для iconname/mainlabel)
			"Allows you to forcibly initiate some procedures if their automatic initialization failed"%_t, -- Содержимое. Текст или путь к картинке.
		},
	},
}
