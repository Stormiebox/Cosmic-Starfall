...
function OCore.initUI()
	...
	OCCbutton1 = OCCwindow:createRoundButton(rectButtons[1], "data/textures/icons/SUBSYSPolarisationNanobots.png",
		"inventoryCheck")
