...
local stationNames = {}
	stationNames['mx'] = "Megacomplex"%_t --название
	
local stationIcons = {}
	stationIcons['mx'] = 'data/textures/icons/MCXmegaComplex.png'
	
local stationDesc = {}
	stationDesc['mx'] = "A megacomplex is a station that allows you to automatically create a logistics of resources between all stations docked to it. In addition, it contains various display and control functionality"%_t
